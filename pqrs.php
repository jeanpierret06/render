<?php
// Configuración de visualización de errores (Opcional, útil en desarrollo)
error_reporting(E_ALL);
ini_set('display_errors', 1);

$mensaje_feedback = "";
$status_feedback = ""; // "success" o "error"
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $documento = [
            ...
            'tipo' => $tipo,
            'detalle' => $detalle,
            'fecha_radicacion' => new MongoDB\BSON\UTCDateTime(new DateTime()) // Fecha/Hora UTC
        ];
        
        // Preparar la operación de inserción en la colección 'pqrs'
        $bulk = new MongoDB\Driver\BulkWrite;
        // Cambia 'mi_base_de_datos' por el nombre real de tu base de datos en Atlas
        $bulk->insert($documento);
        
        // Ejecutar la escritura en el namespace "base_datos.coleccion"
        $manager->executeBulkWrite('mi_base_de_datos.pqrs', $bulk);
